...
def get_init_assignments_for_lloyd(data, the_binwidths, use_kdtree=False):
    ...
    assgnmnts, _, _, _ = uni(data, the_binwidths, placement_scheme='on_mode', use_kdtree=use_kdtree)
...
init_assignments = get_init_assignments_for_lloyd(dummy_data, BINWIDTHS, use_kdtree=True)
